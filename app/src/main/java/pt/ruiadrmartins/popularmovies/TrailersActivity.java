...
/**
 * TrailersActivity Used only on phone version
 */
public class TrailersActivity extends ActionBarActivity {

    static final String TRAILERS_MOVIE_ID_KEY = "movieId";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null) {
            ...
            if(getIntent().hasExtra(TRAILERS_MOVIE_ID_KEY)) {
                arguments.putInt(TrailersActivityFragment.TRAILERS_MOVIE_ID, getIntent().getIntExtra(TRAILERS_MOVIE_ID_KEY, 0));
            } else {
